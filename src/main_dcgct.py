...
parser.add_argument('--use_hyper', type=int, default=0, choices=[0, 1])
...
# optimization args
parser.add_argument('--lr_type', type=str, default='inv', choices=['none', 'inv'], help='type of learning rate scheduler')
